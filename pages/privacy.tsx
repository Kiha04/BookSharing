...
const PrivacyPolicyPage: React.FC = () => {
  return (
    <>
      <Head>
        <title>プライバシーポリシー - 学内図書シェア</title>
      </Head>
...
{/*
        ...
        <h3 className={policyStyles.policySectionTitle}>第3条（個人情報を収集・利用する目的）</h3>
        <p className={policyStyles.policyText}>
        ...
        <h3 className={policyStyles.policySectionTitle}>第4条（利用目的の変更）</h3>
        <ol className={policyStyles.policyList}>
           <li>当社は，利用目的が変更前と関連性を有すると合理的に認められる場合に限り，個人情報の利用目的を変更するものとします。</li>
           <li>利用目的の変更を行った場合には，変更後の目的について，当社所定の方法により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。</li>
        </ol>

        <h3 className={policyStyles.policySectionTitle}>第5条（個人情報の第三者提供）</h3>
        <ol className={policyStyles.policyList}>
            <li>当社は，次に掲げる場合を除いて，あらかじめユーザーの同意を得ることなく，第三者に個人情報を提供することはありません。ただし，個人情報保護法その他の法令で認められる場合を除きます。
                <ol type="a" className={policyStyles.policyList} style={{ listStyleType: 'lower-alpha', marginTop: '0.5em' }}>
                    <li>人の生命，身体または財産の保護のために必要がある場合であって，本人の同意を得ることが困難であるとき</li>
                    <li>公衆衛生の向上または児童の健全な育成の推進のために特に必要がある場合であって，本人の同意を得ることが困難であるとき</li>
                    <li>国の機関もしくは地方公共団体またはその委託を受けた者が法令の定める事務を遂行することに対して協力する必要がある場合であって，本人の同意を得ることにより当該事務の遂行に支障を及ぼすおそれがあるとき</li>
                    <li>予め次の事項を告知あるいは公表し，かつ当社が個人情報保護委員会に届出をしたとき
                        <ol type="i" className={policyStyles.policyList} style={{ listStyleType: 'lower-roman', marginTop: '0.5em' }}>
        ...
        <h3 className={policyStyles.policySectionTitle}>第6条（個人情報の開示）</h3>
        <ol className={policyStyles.policyList}>
        ...
        <h3 className={policyStyles.policySectionTitle}>第7条（個人情報の訂正および削除）</h3>
        <ol className={policyStyles.policyList}>
        ...
        <h3 className={policyStyles.policySectionTitle}>第8条（個人情報の利用停止等）</h3>
        <ol className={policyStyles.policyList}>
